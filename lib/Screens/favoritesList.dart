                      ...
                      itemBuilder: (context, i) {
                        return (favoritsList.isEmpty)
                            ? Container(
                                ...
                                child: Center(
                                    child: Text(
                                  "هیج پەرتووکێکی دلخوازت نییە",
                                  style: TextStyle(
                                      color: Theme.of(context).primaryColor),
                                )),
                              )
                            : (bookSnapshots[i] != null)
                                ? (!favoritsList.contains(bookSnapshots[i].id))
                                    ? Container()
                                    : Container(
                                                            ...
                                                            children: [
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (favoritsList !=
                                                                        ...
                                                                        if (favoritsList
                                                                          ...
                                                                          setState(
                                                                              () {
                                                                            favoritsList.remove(bookSnapshots[i].id);
                                                                          });
                                                                        } else {
                                                                          setState(
                                                                              () {
                                                                            favoritsList.add(bookSnapshots[i].id);
                                                                          });
                                                                        }
                                                                        saveData();
                                                                      }
                                                              ...
                                                              Container(
                                                                  width: width *
                                                                      0.3,
                                                                  child: Text(
                                                                    getTotal(bookSnapshots[i]['publishDate']
                                                                            .toString()) +
                                                                        '\t\t\t\t\t\t' +
                                                                        "سالی چاپ",
                                                                    textAlign:
